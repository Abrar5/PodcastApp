...
//    @Published var isWaitingToSartSearch: Bool = false
//    
//    @Published var homeSections: AllSectionsEntity? {
//        didSet {
//            filteredSections = updateFilterSections()
...
//            print("-- \(homeSections)")
//            self.homeSections = homeSections
//            homeLoadingType = updateHomeLoadingType(sections: homeSections.sections)
//        } catch {
//            homeSections = stubHomeSections()
//            print(error.localizedDescription)
//            homeLoadingType = .done
...
//    }
//    
//    private func updateHomeLoadingType(sections: [SectionEntity]?) -> LoadingType {
//        if sections?.count == 0 {
//            return .empty
//        } else {
//            return .done
...
//            print("-- \(search)")
//            self.search = search
//            searchLoadingType = updateSearchLoadingType(isWaitingToSartSearch: isWaitingToSartSearch)
//            isWaitingToSartSearch = false
//        } catch {
...
//    }
//    
//    private func updateSearchLoadingType(isWaitingToSartSearch: Bool) -> LoadingType {
//        if isWaitingToSartSearch {
//            return .none
//        } else {
//            return .error
//        }
