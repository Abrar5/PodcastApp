...
struct SectionDetailView: View {
    @Binding var section: SectionEntity
    @State private var shouldShowDetails = false
    @State private var content: ViewableContent? = nil
        ...
        VStack {
            ...
            case .square:
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 8) {
                        ForEach($section.viewableContent, id: \.id) { content in
...
struct BigSquareView: View {
    @Binding var content: ViewableContent
    var body: some View {
        VStack() {
